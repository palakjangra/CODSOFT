...
class GUI():
    def __init__(self,master):
        ...
        self.label = Label(text="Password Generator", anchor=N, fg='blue', font='arial 22 bold underline')
        ...
        self.user = Label(text="Enter user name: ", font='times 16')
        self.user.grid(row=4, column=0)

        self.textfield = Entry(textvariable=self.n_username, font='times 16', bd=6, relief='ridge')
        ...
        self.length = Label(text="Enter password length: ", font='times 16')
        ...
        self.generated_password = Label(text="Generated password: ", font='times 16')
        self.generated_password.grid(row=8, column=0)

        self.generated_password_textfield = Entry(textvariable=self.n_generatedpassword, font='times 16', bd=6, relief='ridge', fg='darkgreen')
        ...
        self.generate = Button(text="GENERATE PASSWORD", bd=3, relief='solid', padx=1, pady=1, font='forte 15 bold', fg='red', bg='white', command=self.generate_pass)
        self.generate.grid(row=11, column=1)

        self.blank_label5 = Label(text="")
        self.blank_label5.grid(row=12, column=0)

        self.accept = Button(text="ACCEPT", bd=3, relief='solid', padx=1, pady=1, font='forte 15', fg='blue', bg='white', command=self.accept_fields)
        self.accept.grid(row=13, column=1)

        self.blank_label1 = Label(text="")
        self.blank_label1.grid(row=14, column=1)

        self.reset = Button(text="RESET", bd=3, relief='solid', padx=1, pady=1, font='forte 15', fg='blue', bg='white', command=self.reset_fields)
